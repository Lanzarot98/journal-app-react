...
// mock completo a todas las exportaciones que tenga ese archivo:
jest.mock('../../../src/firebase/providers'); // por esta linea la función signInWithGoogle ya es un mock
...
describe('Pruebas en AuthThunks', () => { 
    ...
    test('Debe de invocar el checkingCredentials', async() => { 
        ...
        // como ya evalué el cambio de estado en el authTest, lo que será el test es que haya sido llamado
        // const valor = checkingCredentials(); // {"payload": undefined, "type": "auth/checkingCredentials"}
        // console.log(valor);
    ...
    test('startGoogleSignIn debe de llamar checkingCredentials y logout - Error', async() => { 
        ...
        // thunk:
        await startGoogleSignIn()( dispatch ); // cuando se mande el signIn se manda el loginData
    ...
    test('startLoginWithEmailPassword debe de llamar checkingCredentials y logout - Error', async() => { 
        ...
        const loginData = { ok: false,  errorMessage: 'Error in start login'};
        const formData = { email: demoUser.email, password: '123456' };
